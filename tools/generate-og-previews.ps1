...
$MainPages = @(
  ...
  @{ Path = "lab/index.html"; Output = "assets/og/lab/lab.png"; Url = "/lab/"; Title = "The Lab"; Subtitle = "Experimental builds and applied studies kept visible while their reasoning is still changing."; Kind = "Lab"; Accent = "#1d4ed8"; Chips = @("mvp", "study", "bench"); Lines = @("Sari2POS", "Trades operations", "Politician tiers", "Service design", "Rough tools") }
)
